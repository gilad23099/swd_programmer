...
// SWD programmer modules
#include "swd_defs.h"        // כל המאקרואים והכתובות
#include "swd_gpio.h"        // GPIO + timing
#include "swd_bitbang.h"     // bit/byte I/O
#include "swd_transfer.h"    // SWD_Send_Request, SWD_Build_Header
#include "swd_dp_ap.h"       // DP/AP low-level access
#include "swd_flash.h"       // Flash unlock/erase/write/verify/lock
#include "swd_control.h"     // Init, HALT, IDCODE, power-up, select AP
